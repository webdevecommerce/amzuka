			...
			<div class="tab-content">
				<div class="tab-pane active" id="category_info">
					...
					?>
						...
						<?php if(!$edit_mode){ ?>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="isChild">Is Child? </label>
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="checkbox">
									<label>
						...
						<div class="form-group">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="checkbox">
									<label>
										<input type="checkbox" class="js-switch" <?php if($edit_mode) if($categories_details->row()->status=='Active') echo 'checked'; ?> name="status" />
									</label>
								</div>
							</div>
						</div>
