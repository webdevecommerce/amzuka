...
$upload_dir = basename(dirname(__FILE__)).'/upload/';

// HERE PERMISSIONS FOR IMAGE
$imgsets = array(
 'maxsize' => 3000,          // maximum file size, in KiloBytes (2 MB)
 'maxwidth' => 3900,          // maximum allowed width, in pixels
 'maxheight' => 3800,         // maximum allowed height, in pixels
